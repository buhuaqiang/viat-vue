...
<script>
    ...
    export default defineComponent({
        setup() {
            ...
            const searchFormFields = ref({"bid_no":"","state":"","modified_date":"","created_date":"","requestor_name":"","group_id":"","cust_id":"","pricegroup_dbid":"","cust_dbid":"","transfer_date":"","mpg_name":""});
            ...
            const columns = ref([{field:'price_transfer_dbid',title:'price_transfer_dbid',type:'guid',width:110,hidden:true,require:true,align:'left'},
                       ...
                       {field:'group_id',title:'Group ID',type:'string',width:80,align:'left'},
                       ...
                       {field:'prod_id',title:'Prod ID',type:'string',width:100,align:'left'},
                       ...
                       {field:'nhi_price',title:'nhi_price',type:'decimal',width:110,hidden:true,align:'left'},
                       ...
                       {field:'invoice_price',title:'invoice_price',type:'decimal',width:110,hidden:true,align:'left'},
                       {field:'net_price',title:'net_price',type:'decimal',width:110,hidden:true,align:'left'},
                       ...
                       {field:'min_qty',title:'min_qty',type:'int',width:110,hidden:true,align:'left'},
                       ...
                       {field:'note',title:'Bid Note',type:'string',width:120,align:'left'},
                       ...
                       {field:'pendingReason',title:'Pending Reason',type:'string',width:200,align:'left'},
