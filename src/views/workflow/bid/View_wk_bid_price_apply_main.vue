    ...
    export default defineComponent({
        setup() {
            ...
            const columns = ref([{field:'bid_no',title:'Bid NO',type:'string',sort:true,width:110,require:true,align:'left',sort:true},
                       ...
                       {field:'bid_date',title:'Bid Date',type:'datetime',width:150,require:true,align:'left',sort:true},
                       {field:'start_date',title:'Start Date',type:'datetime',width:150,require:true,align:'left',sort:true},
                       {field:'end_date',title:'End Date',type:'datetime',width:150,require:true,align:'left',sort:true},
