    ...
    export default defineComponent({
        setup() {
            ...
            const columns = ref([{field:'dbid',title:'列名dbid',type:'int',width:110,hidden:true,require:true,align:'left'},
                       ...
                       {field:'pack_size',title:'Pack Size',type:'decimal',width:90,readonly:true,align:'left'},
                       ...
                       {field:'nhi_price',title:'NHI Price',type:'decimal',width:90,readonly:true,align:'left'},
