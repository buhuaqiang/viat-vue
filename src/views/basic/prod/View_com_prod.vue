    ...
    export default defineComponent({
        setup() {
            ...
            const editFormOptions = ref([[{"dataKey":"entity","data":[],"title":"Entity","field":"entity","disabled":true},
                               {"title":"Item Code","required":true,"field":"prod_id","disabled":true}],
                              ...
                              [{"dataKey":"SunLocalPerform","data":[],"title":"No Stock(Viat)","field":"status_stock_viat","type":"radio"},
            ...
            const columns = ref([{field:'dbid',title:'列名dbid',type:'int',width:110,hidden:true,require:true,align:'left'},
                       {field:'entity',title:'Entity',type:'string',bind:{ key:'entity',data:[]},width:80,readonly:true,align:'left',sort:true},
                       {field:'division',title:'Division',type:'string',bind:{ key:'division',data:[]},width:80,readonly:true,align:'left'},
                       {field:'lmpg_mpg_id',title:'Sales MPG',type:'string',bind:{ key:'sales_mpg',data:[]},width:80,readonly:true,align:'left'},
                       {field:'global_mpg',title:'Finance MPG',type:'string',bind:{ key:'finance_mpg',data:[]},width:80,readonly:true,align:'left'},
                       ...
                       {field:'pack_size',title:'NHI Fact/Dis Percent',type:'decimal',width:110,hidden:true,readonly:true,align:'left'},
                       ...
                       {field:'nhi_price',title:'NHI Price',type:'decimal',width:110,hidden:true,readonly:true,align:'left'},
                       ...
                       {field:'status_sample',title:'Samples Prohibited',type:'string',bind:{ key:'SunLocalPerform',data:[]},width:80,align:'left'},
                       {field:'status_bid',title:'Bids Prohibited',type:'string',bind:{ key:'SunLocalPerform',data:[]},width:80,align:'left'},
                       {field:'status_stock_viat',title:'No Stock(Viat)',type:'string',bind:{ key:'SunLocalPerform',data:[]},width:110,align:'left'},
                       ...
                       {field:'stock_viat',title:'stock_viat',type:'int',width:80,align:'left'},
