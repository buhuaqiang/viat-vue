        ...
        setup() {
            ...
            const editFormOptions = ref([[{"dataKey":"entity","data":[],"title":"Entity","field":"entity","disabled":true},
                              ...
                              [{"title":"Product Name(Chinese)","field":"prod_sname","disabled":true},
                               {"title":"Product Name(English)","field":"prod_ename","disabled":true}],
                             ...
                             /* [{"title":"NHI Fact/Dis Percent","field":"pack_size","disabled":true,"type":"decimal"},
                               {"title":"Pack Size(Pricing)","field":"pack_size_pri","type":"decimal"}],*/
                              ...
                              [{"dataKey":"division","data":[],"title":"Division","field":"division","disabled":true,"type":"select"},
                               {"title":"Product Short Name","field":"prod_short_name","disabled":true}],
                              [{"title":"License Product Name","field":"license_name"},
                               {"title":"License Product No","field":"license_no"}],
                              [{"title":"Form","field":"prod_form","disabled":true},
                               {"title":"Strength","field":"prod_strength","disabled":true}],
                              [{"title":"Packed","field":"prod_packed","disabled":true},
                               {"dataKey":"SunLocalPerform","data":[],"title":"Is Control Drug","field":"is_ctrl_drug","type":"select","disabled":true}],
                             ...
                             /* [{"title":"Sample Safty Stock","field":"safty_stock","type":"number","disabled":true},
