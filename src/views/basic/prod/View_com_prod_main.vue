    ...
    export default defineComponent({
        setup() {
            const table = ref({
                ...
                footer: "Foots",
                cnName: 'Product',
                name: 'prod/View_com_prod_main',
                url: "/View_com_prod_main/",
            ...
            const editFormOptions = ref([[{"dataKey":"entity","data":[],"title":"Entity","field":"entity","type":"select"},
                ...
                [{"dataKey":"finance_mpg","data":[],"title":"Global Mpg","field":"global_mpg","type":"select","required":true},
                    {"dataKey":"sales_mpg","data":[],"title":"Local Mpg","field":"localmpg_dbid","type":"select","required":true}],
               ...
               /* [{"title":"NHI Fact/Dis Percent","field":"pack_size","disabled":true,"type":"decimal"},
                ...
                [{"dataKey":"division","data":[],"title":"Division","field":"division","type":"select"},
                ...
                [{"dataKey":"SunLocalPerform","data":[],"title":"No Stock(Viatris)","field":"status_stock_viat","type":"radio"},
            ...
            const columns = ref([{field:'dbid',title:'列名dbid',type:'int',width:110,hidden:true,require:true,align:'left'},
                       ...
                       {field:'status_viat',title:'status_viat',type:'int',width:110,hidden:true,align:'left'},
