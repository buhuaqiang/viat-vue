        ...
        setup() {
            ...
            const editFormOptions = ref([[{"title":"列名cust_id","required":true,"field":"cust_id"}],
                              ...
                              [{"title":"列名contact","field":"contact"},
                               {"title":"列名tel_no","field":"tel_no"}],
                              [{"title":"列名fax_no","field":"fax_no"},
                               {"title":"列名email","field":"email"}],
                              [{"title":"列名territory_id","field":"territory_id"}],
                              ...
                              [{"dataKey":"doh_type","data":[],"title":"列名doh_type","field":"doh_type","type":"select"},
                               {"dataKey":"doh_type","data":[],"title":"列名margin_type","field":"margin_type","type":"select"}],
            ...
            const searchFormFields = ref({"cust_id":"","cust_name":"","territory_id":"","owner":"","tax_id":"","contact":"","cust_address":"","tel_no":"","doh_institute_no":"","doh_type":"","own_hospital":"","med_group":"","delv_group":"","status":"","cust_zip_id":"","modified_date":"","own_hospitalname":"","med_groupname":"","delv_groupname":""});
            const searchFormOptions = ref([[{"title":"列名cust_id","field":"cust_id","type":"like"},{"title":"列名cust_name","field":"cust_name","type":"like"},{"dataKey":"viat_city_zone","data":[],"title":"客戶地區","field":"cust_zip_id","type":"select"}],[{"title":"列名owner","field":"owner","type":"like"},{"title":"列名contact","field":"contact"},{"title":"列名tel_no","field":"tel_no"}],[{"title":"列名cust_address","field":"cust_address","type":"like"},{"title":"列名tax_id","field":"tax_id"},{"title":"列名territory_id","field":"territory_id"}],[{"title":"列名doh_institute_no","field":"doh_institute_no"},{"dataKey":"doh_type","data":[],"title":"列名doh_type","field":"doh_type","type":"select"},{"dataKey":"Status2","data":[],"title":"列名status","field":"status","type":"select"}],[{"title":"列名med_groupname","field":"med_groupname"},{"title":"列名delv_groupname","field":"delv_groupname"},{"title":"列名own_hospitalname","field":"own_hospitalname"}],[{"title":"列名own_hospital","field":"own_hospital"},{"title":"列名med_group","field":"med_group"},{"title":"列名delv_group","field":"delv_group"}],[{"title":"列名modified_date","field":"modified_date","type":"date"}]]);
            const columns = ref([{field:'cust_id',title:'列名cust_id',type:'string',width:110,require:true,align:'left',sort:true},
                       ...
                       {field:'own_hospital',title:'列名own_hospital',type:'guid',width:110,hidden:true,readonly:true,align:'left'},
                       {field:'med_group',title:'列名med_group',type:'guid',width:110,hidden:true,readonly:true,align:'left'},
                       {field:'delv_group',title:'列名delv_group',type:'guid',width:110,hidden:true,readonly:true,align:'left'},
                       ...
                       {field:'cust_city_name',title:'客戶城市',type:'string',bind:{ key:'viat_city',data:[]},width:120,hidden:true,align:'left'},
                       ...
                       {field:'modified_date',title:'列名modified_date',type:'datetime',width:150,align:'left',sort:true},
                       ...
                       {field:'own_hospitalname',title:'列名own_hospitalname',type:'string',width:110,hidden:true,readonly:true,align:'left'},
                       {field:'med_groupname',title:'列名med_groupname',type:'string',width:110,hidden:true,readonly:true,align:'left'},
                       {field:'delv_groupname',title:'列名delv_groupname',type:'string',width:110,hidden:true,readonly:true,align:'left'},
            ...
            const detail = ref({
                ...
                columns: [{field:'delivery_dbid',title:'delivery_dbid',type:'guid',width:110,hidden:true,require:true,align:'left'},
                       ...
                       {field:'seq_no',title:'seq_no',type:'decimal',width:110,edit:{type:'number'},align:'left',sort:true},
                       {field:'city_name',title:'city_name',type:'string',bind:{ key:'viat_city',data:[]},width:110,edit:{type:'select'},align:'left'},
                       {field:'zip_id',title:'zip_id',type:'string',bind:{ key:'viat_city_zone',data:[]},width:110,edit:{type:'select'},align:'left'},
