...
<script>
    ...
    export default defineComponent({
        setup() {
            ...
            const editFormFields = ref({"prod_dbidname":"","pricegroup_dbidname":"","cust_dbidname":"","i_dist_id":"","start_date":"","e_dist_id":"","end_date":"","modified_date":"","status":"","remarks":"","prod_dbid":"","cust_dbid":"","pricegroup_dbid":""});
            const editFormOptions = ref([[{"title":"Product","required":true,"field":"prod_dbidname"},
                               {"title":"Group ID","required":true,"field":"pricegroup_dbidname"}],
                              [{"title":"Customer","required":true,"field":"cust_dbidname"}],
            ...
            const searchFormFields = ref({"prod_dbid":"","cust_dbid":"","pricegroup_dbid":"","i_dist_id":"","start_date":"","end_date":"","status":"","cust_dbidname":"","prod_dbidname":"","pricegroup_dbidname":""});
            const searchFormOptions = ref([[{"title":"Product","field":"prod_dbidname"},{"title":"Group ID","field":"pricegroup_dbidname"}],[{"title":"Customer","field":"cust_dbidname"},{"dataKey":"distributor_Drop","data":[],"title":"Original Distributor","field":"i_dist_id","type":"select"}],[{"title":"Start Date","field":"start_date","type":"datetime"},{"title":"End Date","field":"end_date","type":"datetime"}],[{"dataKey":"Status_YN","data":[],"title":"Status","field":"status","type":"select"}],[{"title":"","field":"prod_dbid"}],[{"title":"","field":"cust_dbid"}],[{"title":"","field":"pricegroup_dbid"}]]);
            const columns = ref([{field:'distmapping_dbid',title:'distmapping_dbid',type:'guid',width:110,hidden:true,require:true,align:'left'},
