  ...
  <div class=" view-header">
    ...
    <div style="padding-bottom: 10px;padding-left:45px;">
      <el-form :inline="true" label-position="right" label-width="110px" :model="formModel">
        ...
        <el-form-item   label="DIS%:" style="width: 35%">
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {field:'bid_price',title:'Net Price',type:'decimal',width:110,require:true,align:'left'},
        {field:'reserv_price',title:'Reser Price',type:'decimal',width:110,align:'left'},
        {field:'FG%',title:'Reser Price',type:'decimal',width:110,align:'left'},
        {field:'DIS%',title:'Reser Price',type:'decimal',width:110,align:'left'},
