...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {field:'tel_no',title:'聯繫電話',type:'string',width:110,hidden:true,align:'left'},
        {field:'territory_id',title:'默認區域',type:'string',width:110,align:'left'},
        ...
        {field:'doh_type',title:'健保類別',type:'string',bind:{ key:'doh_type',data:[]},width:110,hidden:true,align:'left'},
        {field:'margin_type',title:'毛利類別',type:'string',bind:{ key:'doh_type',data:[]},width:110,hidden:true,align:'left'},
        {field:'status',title:'status',type:'string',bind:{ key:'Status2',data:[]},width:110,hidden:true,align:'left'},
        {field:'modified_date',title:'最后修改时间',type:'datetime',width:150,hidden:true,align:'left',sort:true}],
  ...
  methods: {
    ...
    loadTableBefore(params) {
      ...
      if (this.zip_id) {
        params.wheres = [{ name: "zip_id", value: this.zip_id }];
      }
      return true;
    },
  },
