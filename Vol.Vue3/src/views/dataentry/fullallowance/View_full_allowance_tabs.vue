...
<script>
import table1 from "./View_full_allowance_reverse";
import table2 from "./View_full_allowance_sharing";
import table3 from "./View_full_allowance_sharing";
    ...
    this.tabsButtons = [
      {
        ...
        table: "/View_full_allowance_reverse", //这里填写实际表名用于权限判断(与菜单设置上的表path一样)，没有权限的不会显示
      },
      {
        name: "Sharing",
        icon: "el-icon-shopping-cart-full",
        component: "table2",
        table: "/View_full_allowance_sharing",
      },
      {
        name: "Adjuest",
