    ...
    export default defineComponent({
        setup() {
            ...
            const columns = ref([{field:'dist_id',title:'Distributor',type:'string',bind:{ key:'distributor_Drop',data:[]},width:90,require:true,align:'left',sort:true},
                       ...
                       {field:'margin_value',title:'Margin Rate/Price',type:'decimal',width:90,require:true,align:'left'},
                       ...
                       {field:'prod_id_show',title:'Prod ID-test',type:'string',width:110,hidden:true,align:'left'},
                       {field:'cust_id_show',title:'Cust ID-test',type:'string',width:60,hidden:true,align:'left'},
