...
<script>
    ...
    export default defineComponent({
        setup() {
            ...
            const editFormFields = ref({"dist_id":"","prod_id":"","prod_ename":"","margin_value_type":"","margin_value":"","prod_dbidname":"","start_date":"","cust_dbidname":"","end_date":"","channel":"","cust_id":"","cust_name":"","status":""});
            const editFormOptions = ref([[{"dataKey":"distributor_Drop","data":[],"title":"Distributor","required":true,"field":"dist_id","type":"select"},
                               ...
                               {"title":"Margin Rate/Price","field":"margin_value","type":"text"},
            ...
            const columns = ref([{field:'dist_id',title:'Distributor',type:'string',bind:{ key:'distributor_Drop',data:[]},width:90,require:true,align:'left',sort:true},
                       {field:'sys_value',title:'Dist Name',type:'string',link:true,width:60,align:'left'},
                       {field:'prod_dbid',title:'prod_dbid',type:'guid',width:40,align:'left'},
                       {field:'prod_id',title:'Prod ID',type:'string',width:50,align:'left'},
                       {field:'prod_ename',title:'Prod Name',type:'string',width:60,align:'left'},
                       ...
                       {field:'margin_value_type',title:'Margin Type',type:'int',bind:{ key:'Margin_Type',data:[]},width:70,align:'left'},
                       {field:'margin_value',title:'Margin Rate/Price',type:'decimal',width:90,align:'left'},
