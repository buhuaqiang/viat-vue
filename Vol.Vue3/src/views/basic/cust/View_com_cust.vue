        ...
        setup() {
            ...
            const editFormOptions = ref([[{"title":"Customer  Code","required":true,"field":"cust_id"},
                              ...
                              [{"title":"Controlled Medicine Contact","field":"ctrl_drug_contact"},
                               {"dataKey":"Status_YN","data":[],"title":"Is contracted","field":"is_contract","type":"select"}],
                              [{"dataKey":"Status_YN","data":[],"title":"Public/Private","field":"is_private","type":"select"},
                               {"dataKey":"Status2","data":[],"title":"Status","field":"status","type":"select"}],
                              [{"dataKey":"Status_YN","data":[],"title":"Is Hospital Owned Drug Store","required":true,"field":"own_by_hospital","type":"select"},
                               {"title":"Owned Hospitalname","required":true,"field":"own_hospitalname","disabled":true}],
                              [{"title":"Medical Group","field":"med_groupname","disabled":true},
                               {"title":"Price Group","field":"delv_groupname","disabled":true}],
            ...
            const searchFormOptions = ref([[{"title":"Customer  Code","field":"cust_id","type":"like"},{"dataKey":"entity","data":[],"title":"Entity","field":"entity","type":"select"},{"dataKey":"viat_city_zone","data":[],"title":"Customer Zip Code","field":"cust_zip_id","type":"select"},{"dataKey":"division","data":[],"title":"Division","field":"division","type":"select"}],[{"title":"Owner","field":"owner","type":"like"},{"title":"Customer name","field":"cust_name","type":"like"},{"title":"Contact","field":"contact"},{"title":"Telephone","field":"tel_no"}],[{"title":"Customer address","field":"cust_address","type":"like"},{"title":"Tax ID","field":"tax_id"},{"title":"Default Zone","field":"territory_id"},{"title":"NHI Institute no","field":"doh_institute_no"}],[{"dataKey":"Status_YN","data":[],"title":"Is Hospital Owned Drug Store","field":"own_by_hospital","type":"select"},{"title":"Owned Hospitalname","field":"own_hospitalname"},{"title":"Medical Group","field":"med_groupname"},{"title":"Price Group","field":"delv_groupname"}],[{"dataKey":"doh_type","data":[],"title":"DOH Type","field":"doh_type","type":"select"},{"dataKey":"Status2","data":[],"title":"Status","field":"status","type":"select"},{"title":"Modified Date","field":"modified_date","type":"date"}],[{"title":"Owned Hospital","field":"own_hospital"},{"title":"Medical Group","field":"med_group"},{"title":"Price Group","field":"delv_group"}]]);
            const columns = ref([{field:'cust_id',title:'Customer  Code',type:'string',link:true,width:110,require:true,align:'left',sort:true},
                       ...
                       {field:'is_contract',title:'Is contracted',type:'string',bind:{ key:'Status_YN',data:[]},width:110,hidden:true,align:'left'},
                       {field:'is_private',title:'Public/Private',type:'string',bind:{ key:'Status_YN',data:[]},width:110,hidden:true,align:'left'},
                       {field:'own_by_hospital',title:'Is Hospital Owned Drug Store',type:'string',bind:{ key:'Status_YN',data:[]},width:110,hidden:true,require:true,align:'left'},
                       {field:'own_hospital',title:'Owned Hospital',type:'guid',width:110,hidden:true,readonly:true,align:'left'},
                       {field:'med_group',title:'Medical Group',type:'guid',width:110,hidden:true,readonly:true,align:'left'},
                       {field:'delv_group',title:'Price Group',type:'guid',width:110,hidden:true,readonly:true,align:'left'},
                       ...
                       {field:'remarks',title:'Remarks',type:'string',width:220,hidden:true,align:'left'},
                       ...
                       {field:'own_hospitalname',title:'Owned Hospitalname',type:'string',width:110,hidden:true,readonly:true,require:true,align:'left'},
                       {field:'med_groupname',title:'Medical Group',type:'string',width:110,hidden:true,readonly:true,align:'left'},
                       {field:'delv_groupname',title:'Price Group',type:'string',width:110,hidden:true,readonly:true,align:'left'},
