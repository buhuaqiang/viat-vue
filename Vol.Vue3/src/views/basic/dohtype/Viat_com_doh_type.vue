...
<script>
    ...
    export default defineComponent({
        setup() {
            ...
            const editFormFields = ref({"doh_type":"","doh_type_name":"","doh_type_ename":"","report_type":"","status":"","doh_map_type":""});
            const editFormOptions = ref([[{"title":"健保局類別名稱","field":"doh_type_name"},
