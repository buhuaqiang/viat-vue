    ...
    export default defineComponent({
        setup() {
            ...
            const editFormOptions = ref([[{"dataKey":"entity","data":[],"title":"Entity","field":"entity","type":"select"},
                              ...
                              [{"title":"NHI Fact/Dis Percent","field":"pack_size","type":"decimal"},
                               {"title":"Pack Size(Pricing)","field":"pack_size_pri","type":"decimal"}],
                              [{"title":"NHI Price","field":"nhi_price","type":"decimal"}],
                              [{"dataKey":"division","data":[],"title":"Division","field":"division"},
                              ...
                              [{"dataKey":"SunLocalPerform","data":[],"title":"No Stock(Pfizer)","field":"status_stock_pfizer","type":"radio"},
