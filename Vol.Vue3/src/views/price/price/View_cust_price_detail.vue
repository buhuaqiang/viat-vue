...
<script>
    ...
    export default defineComponent({
        setup() {
            ...
            const editFormFields = ref({"status":"","bid_no":"","cust_dbidname":"","prod_dbidname":"","start_date":"","end_date":"","nhi_price":"","invoice_price":"","net_price":"","min_qty":"","remarks":"","prod_dbid":"","cust_dbid":""});
            ...
            const columns = ref([{field:'pricedetail_dbid',title:'pricedetail_dbid',type:'guid',width:110,hidden:true,require:true,align:'left'},
                       ...
                       {field:'group_id',title:'Group ID',type:'string',width:110,require:true,align:'left'},
                       ...
                       {field:'nhi_price',title:'NHI Price',type:'decimal',width:110,require:true,align:'left'},
                       ...
                       {field:'prods',title:'Products',type:'string',bind:{ key:'mul_select_for_pop',data:[]},width:110,require:true,align:'left'},
