    ...
    export default defineComponent({
        setup() {
            ...
            const columns = ref([{field:'pricedetail_dbid',title:'pricedetail_dbid',type:'guid',width:110,hidden:true,require:true,align:'left'},
                       ...
                       {field:'nhi_price',title:'NHI Price',type:'decimal',width:80,align:'left',sort:true},
                       {field:'invoice_price',title:'Invoice Price',type:'decimal',width:80,align:'left',sort:true},
                       {field:'net_price',title:'Net Price',type:'decimal',width:80,align:'left',sort:true},
                       {field:'gross_price',title:'Gross Price',type:'decimal',width:80,align:'left',sort:true},
                       {field:'reserv_price',title:'Reserve Price',type:'decimal',width:110,align:'left',sort:true},
                       {field:'min_qty',title:'Min Qty',type:'int',width:80,align:'left',sort:true},
