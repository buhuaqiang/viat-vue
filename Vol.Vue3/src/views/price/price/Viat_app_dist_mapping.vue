    ...
    export default defineComponent({
        setup() {
            ...
            const editFormOptions = ref([[{"title":"產品表PKID","field":"prod_dbid","type":"text"}],
                              ...
                              [{"dataKey":"distributor_Drop","data":[],"title":"歸屬經銷商","field":"i_dist_id","type":"select"},
                               {"title":"生效日","required":true,"field":"start_date","type":"datetime"}],
                              [{"dataKey":"distributor_Drop","data":[],"title":"原始經銷商","required":true,"field":"e_dist_id","type":"select"},
            ...
            const columns = ref([{field:'distmapping_dbid',title:'PKID',type:'guid',width:110,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'e_dist_id',title:'原始經銷商',type:'string',bind:{ key:'distributor_Drop',data:[]},width:110,require:true,align:'left'},
                       {field:'i_dist_id',title:'歸屬經銷商',type:'string',bind:{ key:'distributor_Drop',data:[]},width:110,align:'left'},
